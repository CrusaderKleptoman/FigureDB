        ...
        try {
            ...
            while(rs.next())
            {
                ...
                while(rsCollection.next())
                {
                    ...
                    PreparedStatement psFigure = connection.prepareStatement("SELECT * FROM figure WHERE id = ?");
                    psCollection.setInt(1, figureId);
                ...
                person.setCollection(rs.getString("CollectionName"), collection);
